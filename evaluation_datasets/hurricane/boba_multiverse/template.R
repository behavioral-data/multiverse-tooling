...
{
  "decisions": [
    {"var": "outliers", "options": [ # Katrina, Andrew, Sandy, Donna all have very high values for damage predictor variable (outliers)
        "c()",                      # Katrina and Audrey have very high values for death outcome variable
        "c('Katrina')",
        "c('Katrina', 'Audrey')",
    ...
    {"var": "feminity", "options": ["female", "masfem"]},  # whether we operationalize by binary variable or scale from masculine to feminine
    {"var": "feminity_prediction_levels", "options": ["c(0, 1)", "c(2.53, 8.29)"]},
    {"var": "damage", "options": ["dam", "log_dam"]}, # log damaage or just damage
